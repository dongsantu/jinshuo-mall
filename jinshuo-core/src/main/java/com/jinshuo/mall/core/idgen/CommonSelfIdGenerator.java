package com.jinshuo.mall.core.idgen;

import com.google.common.base.Preconditions;
import com.google.common.base.Strings;
import com.jinshuo.mall.core.idgen.time.AbstractClock;
import com.jinshuo.mall.core.util.RandomUtil;
...
public class CommonSelfIdGenerator {
    ...
    public static String getNoWithTime() {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyyMMdd");
        return simpleDateFormat.format(new Date()) + RandomUtil.getNumRandom(8);
    }
}
